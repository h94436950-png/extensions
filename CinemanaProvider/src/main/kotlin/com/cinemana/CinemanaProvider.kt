...
class CinemanaProvider : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        "$apiBase/newlyVideosItems/level/0/offset/12/page/" to "مُضاف حديثًا",
        ...
        // Arabic Series
        "$apiBase/video/V/2?videoKind=2&langNb=9&itemsPerPage=30&pageNumber=&level=0&sortParam=views_desc" to "مسلسلات عربية",
